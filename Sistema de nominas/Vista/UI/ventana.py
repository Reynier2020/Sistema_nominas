...
"border:1px solid #167;")
        ...
        self.pushButton_refres.setIcon(icon1)
...
"border:1px solid #167;")
        ...
        self.pushButton_buscar_vin = QtWidgets.QPushButton(self.tab_vinculados)
        self.pushButton_buscar_vin.setMinimumSize(QtCore.QSize(35, 22))
        self.pushButton_buscar_vin.setMaximumSize(QtCore.QSize(38, 22))
        self.pushButton_buscar_vin.setAutoFillBackground(False)
        self.pushButton_buscar_vin.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border:1px solid #167;\n"
"")
        self.pushButton_buscar_vin.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../iconos/busqueda.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_buscar_vin.setIcon(icon2)
        self.pushButton_buscar_vin.setIconSize(QtCore.QSize(25, 20))
        self.pushButton_buscar_vin.setCheckable(False)
        self.pushButton_buscar_vin.setChecked(False)
        self.pushButton_buscar_vin.setAutoDefault(False)
        self.pushButton_buscar_vin.setDefault(False)
        self.pushButton_buscar_vin.setFlat(False)
        self.pushButton_buscar_vin.setObjectName("pushButton_buscar_vin")
        self.horizontalLayout_6.addWidget(self.pushButton_buscar_vin)
...
"border:1px solid #167;")
        ...
        self.pushButton_buscar_no = QtWidgets.QPushButton(self.tab_no_vinculado)
        self.pushButton_buscar_no.setMinimumSize(QtCore.QSize(35, 22))
        self.pushButton_buscar_no.setMaximumSize(QtCore.QSize(38, 22))
        self.pushButton_buscar_no.setAutoFillBackground(False)
        self.pushButton_buscar_no.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border:1px solid #167;\n"
"")
        self.pushButton_buscar_no.setText("")
        self.pushButton_buscar_no.setIcon(icon2)
        self.pushButton_buscar_no.setIconSize(QtCore.QSize(25, 20))
        self.pushButton_buscar_no.setCheckable(False)
        self.pushButton_buscar_no.setChecked(False)
        self.pushButton_buscar_no.setAutoDefault(False)
        self.pushButton_buscar_no.setDefault(False)
        self.pushButton_buscar_no.setFlat(False)
        self.pushButton_buscar_no.setObjectName("pushButton_buscar_no")
        self.horizontalLayout_2.addWidget(self.pushButton_buscar_no)
...
"border:1px solid #167;")
        ...
        self.pushButton_buscar_proy = QtWidgets.QPushButton(self.tab_proyectos)
        self.pushButton_buscar_proy.setMinimumSize(QtCore.QSize(35, 22))
        self.pushButton_buscar_proy.setMaximumSize(QtCore.QSize(38, 22))
        self.pushButton_buscar_proy.setAutoFillBackground(False)
        self.pushButton_buscar_proy.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border:1px solid #167;\n"
"")
        self.pushButton_buscar_proy.setText("")
        self.pushButton_buscar_proy.setIcon(icon2)
        self.pushButton_buscar_proy.setIconSize(QtCore.QSize(25, 20))
        self.pushButton_buscar_proy.setCheckable(False)
        self.pushButton_buscar_proy.setChecked(False)
        self.pushButton_buscar_proy.setAutoDefault(False)
        self.pushButton_buscar_proy.setDefault(False)
        self.pushButton_buscar_proy.setFlat(False)
        self.pushButton_buscar_proy.setObjectName("pushButton_buscar_proy")
        self.horizontalLayout_5.addWidget(self.pushButton_buscar_proy)
